...
# Define the model of a MLP with the best parameters
...
# Define the model of a SVR_RBF with the best parameters
...
# Define the model of a ETR with the best parameters
...
def main():
    # If there is no arguments, the script test all the models
    if len(sys.argv) == 1:
        ...
        # Print times and MEE erro for each model
    ...
    # If the argument is 'predict', the best model predicts the results for the CUP
