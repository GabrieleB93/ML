...
x, y = Variable(inputs), Variable(targets)
print(x)
print(y)
# view data
...
net = Net(n_feature=10, n_hidden=1, n_output=2)  # define the network
# print(net)  # net architecture
optimizer = torch.optim.SGD(net.parameters(), lr=0.2, momentum=0.6, weight_decay=0.2)
